...
import { Download, ArrowLeft, Users, Clock, Target } from 'lucide-react';
...
const Analytics: React.FC<AnalyticsProps> = ({ study, results, onBack }) => {
  const [activeTab, setActiveTab] = useState<'overview' | 'similarity' | 'categories'>('overview');

  const categoryFrequencies = CategoryAnalysis.calculateCategoryFrequency(results);
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Card Sorting Study Results</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div key={category.categoryId} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-sm text-gray-600">
                        {category.usage} / {results.length} participants ({category.percentage.toFixed(1)}%)
                      </div>
                    </div>
